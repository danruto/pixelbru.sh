...
>(({ className, ...props }, ref) => (
    <CommandPrimitive.Separator ref={ref} className={ny("bg-border -mx-1 h-px", className)} {...props} />
))
...
function CommandShortcut({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
    return <span className={ny("text-muted-foreground ml-auto text-xs tracking-widest", className)} {...props} />
}
