...
>(({ className, ...props }, ref) => {
    ...
    return <Label ref={ref} className={ny(error && "text-destructive", className)} htmlFor={formItemId} {...props} />
})
...
const FormGlobalError = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
    ({ className, ...props }, ref) => {
