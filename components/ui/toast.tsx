...
>(({ className, variant, ...props }, ref) => {
    return <ToastPrimitives.Root ref={ref} className={ny(toastVariants({ variant }), className)} {...props} />
})
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Title ref={ref} className={ny("text-sm font-semibold [&+div]:text-xs", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Description ref={ref} className={ny("text-sm opacity-90", className)} {...props} />
))
